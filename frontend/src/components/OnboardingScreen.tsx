...
export const OnboardingScreen: React.FC = () => {
  ...
  return (
    <div className="relative flex h-screen w-full items-center justify-center bg-zinc-50 text-zinc-950 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md p-8 rounded-2xl bg-white border border-zinc-200 backdrop-blur-xl shadow-2xl">
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <label className="text-sm font-medium text-zinc-500">Select Exercise Module</label>
            <select
              value={selectedExercise}
              onChange={(e) => setSelectedExercise(e.target.value)}
              className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-4 py-3 outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all appearance-none"
            >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white font-semibold rounded-xl px-4 py-3 transition-all active:scale-[0.98] shadow-sm"
          >
