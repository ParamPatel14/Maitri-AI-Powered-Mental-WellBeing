...
def draw_shoulder_press_hud(frame: np.ndarray, result) -> None:
    h, w = frame.shape[:2]
    ...
    panel_x = w - 250
    blend_rect(frame, panel_x, 10, w - 10, 150, DARK)
    ...
    cv2.putText(frame, f"Torso: {result.torso_angle:5.1f}°", (panel_x + 12, 124), FONT, 0.55, WHITE, 1, cv2.LINE_AA)
